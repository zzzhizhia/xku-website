...
import UwU from './[locale]/xku-campus-uwu.jpg'

const links = [
  { href: '/', label: 'Home', icon: TbPlanet },
  { href: '/about', label: 'About', icon: Logo },
  ...
  { href: 'https://github.com/orgs/sico-university/repositories', label: 'Shop', icon: ShopIcon },
  // { href: '/gallery', label: 'Gallery', icon: TbPhoto },
]
const social = [
  {
    name: 'Twitter',
    url: 'https://twitter.com/sico-university',
    icon: BrandXIcon,
  },
  {
    name: 'GitHub',
    url: 'https://github.com/sico-university',
    icon: BsGithub,
  },
  {
    name: 'YouTube',
    url: 'https://youtube.com/@sico-university',
    icon: BsYoutube,
  },
  {
    name: 'Email',
  ...
  return (
    ...
    >
      <motion.div className="md:sticky md:top-12 md:pr-4" layout layoutRoot>
        ...
        >
          {isUWU ? (
            <Image className="w-20" src={UwU} alt="xku logo uwu" />
          ) : (
            <motion.span
